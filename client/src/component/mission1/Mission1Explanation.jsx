    ...
    return (
        <div className={'mission-explanation'}>
            ...
            <p>
                ...
                La seconde erreur a été l'utilisation d'un mot de passe trop simple et donc trop faible.
                En effet, un hacker va pouvoir, avec les outils qu'il a sa disposition (et sans même se renseigner sur vous)
                trouver ce mot de passe. En effet, les mots utilisés dans ce mot de passe sont fréquemment présents dans d'autres mots de passe.
            </p>
            ...
            <ul className={'rules-password-explanation'}>
                ...
                <li><b>Un compte = un nouveau mot de passe </b>(afin d'éviter d'être piraté sur tous vos comptes)</li>
                <li>
                    Ne jamais écrire vos mots de passe dans <b>un espace non sécurisé</b> (smartphone, post-it, fichier texte, etc.)
                    <ul>
                        <li>Il est conseiller d'utiliser un gestionnaire de mots de passe comme keepass, lastpass, bitwarden</li>
                    </ul>
                </li>
            </ul>
